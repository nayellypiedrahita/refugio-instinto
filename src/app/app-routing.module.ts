...
import { EnviadoTestimonioComponent } from './administrador/pages/enviado-testimonio/enviado-testimonio.component';
...
const routes: Routes = [
  { 
    path: 'web', component: WebComponent, children: [
      ...
      { path: 'texto-apadrinar/:idmascota', component: TextoApadrinarComponent },
      ...
      { path: 'formulario-de-apadrinamiento/:idmascota', component: FormularioDeApadrinamientoComponent },
  ...
  },
  {
    path: "admin", component: AdministradorComponent, canActivateChild: [ AuthGuard ], children: [
      ...
      { path: "enviado-testimonio",  component: EnviadoTestimonioComponent },
